...
//         } catch (\Exception $e) {
    ...
    public function getSearchQuery(&$searchData, $orderby)
    {
    ...
    public function getSearchQueryGroupBy($searchData = array(), $params = array())
    {
    ...
    public function searchQuery(Request $req)
    {
        ...
        $query = $this->getSearchQuery($searchData, $orderby);
        ...
        $query->setDQL($query->getDQL() . $this->getSearchQueryGroupBy($searchData));

        if (isset($orderby)) {
            $this->getSearchQueryOrderBy($query, $orderby, $order);
        }

        return $query->setHydrationMode(Query::HYDRATE_ARRAY);
    }

    public function getSearchQueryOrderBy($query, $orderby, $order)
    {
